...
public class SpeedQuizSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO quiz VALUES(7,\"Nami est la seule femme dans l'équipage de Luffy\",0)");
        db.execSQL("INSERT INTO quiz VALUES(8,\"Une toyota supra à comme moteur un 2JZ\",1)");
        db.execSQL("INSERT INTO quiz VALUES(9,\"Luffy a mangé le fruit du Gum Gum\",1)");
        db.execSQL("INSERT INTO quiz VALUES(10,\"Zoro a déja mangé un fruit du démon\",0)");
    }
    @Override
